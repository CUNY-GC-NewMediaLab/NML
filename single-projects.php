...
<!-- this file is picked up by items in the projets custom post type -->
			<div id="post-<?php the_ID() ?>" class="<?php sandbox_post_class() ?>">
				...
				<div class="entry-content"><h2>This is for custom post type "projects" </h2>
               <?php
               // this is where the archive link is, should you need it 
               // $z = get_post_type_archive_link( 'projects' );
              // echo $z; ?> 
<?php
